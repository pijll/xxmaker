...
Tile(10, Colour.phase_2, City("A", 30, -0.3, -0.6), City("B", 30, 0.3, 0.6, value_location=(-0.7, 0)),
     Connect(NW, "A"), Connect(SE, "B"))
...
Tile(35, Colour.phase_3, Connect(SW, SE, City(value=40, location=0.25, value_location=(0.15, -0.6)), over=True),
     Connect(S, NW, City(value=40, location=0.75, value_location=(.5, -0.3)), under=True))
Tile(36, Colour.phase_3, Connect(S, NW, City(value=40, location=0.75, value_location=(-0.1, 0.6))),
     Connect(N, SE, City(value=40, location=0.75, value_location=(0.1, -0.6))))
Tile(37, Colour.phase_3, City('A', x=-0.5, y=-0.3, value=40, value_location=(-0.1, 0.6)),
     City('B', x=0.5, y=0.3, value=40, value_location=(0.1, -0.6)), Connect(S, N), Connect(S, 'A'), Connect(N, 'B'))
...
Tile(54, Colour.phase_2, Connect(N, NW, City(value=60)), Connect(S, SW, City(value=60)), Label('NY', (0.7, 0)))
...
Tile(59, Colour.phase_2, City(id_='A', value=40, x=-0.3, y=0.5), City(id_='B', value=40, x=0.3, y=-0.5, value_location=(-0.7, 0)),
     Connect(S, 'A'), Connect(NE, 'B'), Label('OO', (0.7, 0)))   # 1830
Tile(61, Colour.phase_3, Connect(N, S, City(id_='B', value=60, value_location=(0.4, -0.7))),
     Connect(NW, 'B'), Connect(NE, 'B'), Label('B'))    # 1830
Tile(62, Colour.phase_3, DoubleCity(id_='N', value=80, x=0, y=-0.6, value_location=(-0.7, 0.6)), Connect(NW, 'N'),
     ...
     Connect(S, 'S'), Connect(SW, 'S'), Label('NY', (0, 0)))    # 1830
...
Tile(64, Colour.phase_3, Connect(N, NE, City(value=50, value_location=(-0.6, -0.2))),
     Connect(S, NW, City(value=50, value_location=(0.6, 0.4))), Label('OO', (0.7, 0)))    # 1830
Tile(65, Colour.phase_3, Connect(SE, NE, City(value=50, value_location=(-0.3, -0.6))),
     Connect(S, NW, City(value=50, location=0.6, value_location=(-0.1, 0.6))), Label('OO', (-0.4, -0.6)))    # 1830
Tile(66, Colour.phase_3, Connect(N, S, City(value=50, location=0.2, value_location=(0.6, 0.3))),
     Connect(SW, NW, City(value=50, value_location=(0.2, 0.6))), Label('OO', (0.6, 0.2)))    # 1830
Tile(67, Colour.phase_3, Connect(S, NE, City(value=50, location=0.25, value_location=(-0.3, -0.5)), over=True),
     ...
     Label('OO', (-0.3, -0.8)))    # 1830
Tile(68, Colour.phase_3, Connect(N, S, City(value=50, location=0.8, value_location=(-0.6, -0.15)), under=True),
     Connect(SE, NW, City(value=50, location=0.8, value_location=(+.9, -0.2)), over=True), Label('OO', (0.7, 0)))    # 1830
